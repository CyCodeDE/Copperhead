        ...
        while let Ok(cmd) = rx.try_recv() {
            match cmd {
                ...
                SimCommand::LoadCircuit(netlist) => {
                    ...
                    let new_ckt = processor.as_ref().unwrap().get_circuit_ref();
        ...
        if running {
            ...
            if current_step >= max_steps {
                ...
                if steps_performed > 0 {
                    ...
                    proc.get_circuit_mut().extract_history(&mut active_batch);
                }
                ...
                if current_step >= max_steps {
                    ...
                    for probe in &proc.get_circuit_ref().components.audio_probes {
